library carousel_slider_indicator;

import 'dart:async';

import 'package:carousel_slider_indicator/carousel_state.dart';
...
class CarouselSliderIndicator extends StatefulWidget {
  ...
  CarouselSliderIndicator(
      {@required this.items, @required this.options, carouselController, Key key})
      : itemBuilder = null,
  ...
  CarouselSliderIndicator.builder(
  ...
  @override
  CarouselSliderIndicatorState createState() => CarouselSliderIndicatorState(_carouselController);
}

class CarouselSliderIndicatorState extends State<CarouselSliderIndicator>
  ...
  CarouselSliderIndicatorState(this.carouselController);
  ...
  @override
  void didUpdateWidget(CarouselSliderIndicator oldWidget) {
  ...
  Widget getEnlargeWrapper(Widget child, {double width, double height, double scale}) {
    ...
    return Transform.scale(
        scale: scale, child: Container(child: child, width: width, height: height));
  }
